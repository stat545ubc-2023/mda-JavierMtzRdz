...
In the previous sections of this analysis, we have made progress toward understanding the primary characteristics of street trees in each neighbourhood. We have explored various aspects such as tree most common species, planting dates, diameters and root barriers, which  However, it seems to be a small portion . For instance, we may need to investigate further factors like tree health, biodiversity, and environmental conditions that contribute to the overall characteristics of the forest ecosystem.
